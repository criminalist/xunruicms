...
var hui = (function(selector){
	...
	_hui.countdownBase = function(timer, domId, showType){
		var reg    = /^([0-9]{4})-([0-9]{2})-([0-9]{2}) ([0-9]{2}):([0-9]{2}):([0-9]{2})$/;
			...
			if(res == null){console.log('Time format error'); return false;}
			var year  = parseInt(res[1]);
			if(year < 1000){console.log('Time format error'); return false;}
			var month = parseInt(res[2]);
			var day   = parseInt(res[3]);
			var h     = parseInt(res[4]);
			if(h < 0 || h > 24){console.log('Time format error'); return false;}
			var i     = parseInt(res[5]);
			if(i < 0 || i > 60){console.log('Time format error'); return false;}
			var s     = parseInt(res[6]);
			if(s < 0 || s > 60){console.log('Time format error'); return false;}
